...
public extension CGRect {
	...
	- Returns: A new rectangle, cenetered vertically in `containerRect`, with the same size as the source rectangle.
	*/
	...
	- Parameter containerRect: The rectangle in which to be centered.
	- Returns: A new rectangle, cenetered horizontally in `containerRect`, with the same size as the source rectangle.
	*/
	...
	- Parameter containerRect: The rectangle in which to be centered.
	- Returns: A new rectangle, cenetered both horizontally and vertically in `containerRect`, with the same size as the source rectangle.
	*/
